...
class RoutingExperiment
{
  ...
  private:
    ...
    int m_nSinks{30};                                      //!< Number of sink nodes.
...
RoutingExperiment::Run()
{
    ...
    wifiPhy.EnableAsciiAll(ascii.CreateFileStream("manet-dsdv.tr"));
	...
	NS_LOG_UNCOND(std::endl<<"--------Total Results of the simulation----------"<<std::endl);
	...
	NS_LOG_UNCOND("Total Number of Packet transmission =" << j);
	flowmon->SerializeToXmlFile("manet-routing.xml", false, false);
